 ...
 * @Project : joe
 * @Package : joe.elasticsearch.helper.factory.agg
 * @Description : DATE_HISTOGRAM AggregationBuilder Factory
 * @date : 2018年09月30日 16:29
 */
@Component
@AggFactoryType(AggType.DATE_HISTOGRAM)
public class DateHistogramAggFactory implements AggFactory {
    /**
     * @param agg 通用AGG模型
    ...
    public AggregationBuilder createAgg(GeneralAgg agg) {
        // TODO 因时间类型暂未使用，未实现
        return AggregationBuilders.dateHistogram(agg.getAggName()).field(agg.getField());
    }
